...
R package **mrtransport**, version **0.3.0**
...
Hoppe J, Dirnaichner A (2024). _mrtransport: Input data generation for the EDGE-Transport model_. R package version 0.3.0, <https://github.com/pik-piam/mrtransport>.
