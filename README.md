...
R package **mrtransport**, version **0.7.3**
...
Hoppe J, Muessel J, Dirnaichner A (2024). _mrtransport: Input data generation for the EDGE-Transport model_. R package version 0.7.3, <https://github.com/pik-piam/mrtransport>.
