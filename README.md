...
R package **mrtransport**, version **0.17.1**
...
Hoppe J, Muessel J, Hagen A, Dirnaichner A (2026). "mrtransport: Input data generation for the EDGE-Transport model." Version: 0.17.1, <https://github.com/pik-piam/mrtransport>.
