...
R package **mrtransport**, version **0.10.5**
...
Hoppe J, Muessel J, Hagen A, Dirnaichner A (2025). "mrtransport: Input data generation for the EDGE-Transport model." Version: 0.10.5, <https://github.com/pik-piam/mrtransport>.
