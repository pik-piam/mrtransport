...
R package **mrtransport**, version **0.5.0.9001**
...
Hoppe J, Muessel Jj, Dirnaichner A (2024). _mrtransport: Input data generation for the EDGE-Transport model_. R package version 0.5.0.9001, <https://github.com/pik-piam/mrtransport>.
