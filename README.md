...
R package **mrtransport**, version **0.8.1**
...
Hoppe J, Muessel J, Dirnaichner A (2024). _mrtransport: Input data generation for the EDGE-Transport model_. R package version 0.8.1, <https://github.com/pik-piam/mrtransport>.
